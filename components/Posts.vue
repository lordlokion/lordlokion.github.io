    ...
    <section class="pt-20 pb-32 overflow-hidden">
      <div class="container mx-auto px-4">
        ...
        <div class="flex flex-wrap -m-9">
          <div v-for="(post, index) in latestPosts" :key="index" class="w-full md:w-1/3 p-9">
            <a :href="post.url" class="group">
              <div class="group flex flex-col mb-5 overflow-hidden rounded-xl aspect-w-3 aspect-h-2 h-64">
                <img :src="post.image" class="object-cover w-full h-full transform group-hover:scale-110 transition ease-out duration-500 rounded-xl" alt="">
              </div>
